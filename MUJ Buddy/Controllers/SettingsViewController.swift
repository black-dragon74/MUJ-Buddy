...
class SettingsViewController: UITableViewController {
    @IBOutlet var currentSemLabel: UILabel!
    @IBOutlet var refreshIntervalLabel: UILabel!
    @IBOutlet var lowAttendanceSwitch: UISwitch!
    @IBOutlet var biometrySwitch: UISwitch!
    @IBOutlet var apiStatusView: UIView!
    @IBOutlet var dmsStatusView: UIView!
    @IBOutlet var notificationThreshold: UILabel!
