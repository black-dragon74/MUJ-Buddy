...
extension UIColor {
    // Darker colors
    static var skyBlue: UIColor { UIColor(r: 48, g: 205, b: 196) }
    static var babyPink: UIColor { UIColor(r: 244, g: 145, b: 162) }
    static var indigo: UIColor { UIColor(r: 182, g: 139, b: 244) }
    static var jetStream: UIColor { UIColor(r: 110, g: 142, b: 163) }
    static var paleOrange: UIColor { UIColor(r: 237, g: 150, b: 82) }
    static var teal: UIColor { UIColor(r: 1, g: 115, b: 92) }
    static var warmPurple: UIColor { UIColor(r: 103, g: 79, b: 125) }
    static var brickRed: UIColor { UIColor(r: 240, g: 97, b: 69) }
    static var navyBlue: UIColor { UIColor(r: 27, g: 38, b: 56) }
    static var mujTheme: UIColor { UIColor(r: 255, g: 152, b: 0) }
    static var parrotGreen: UIColor { UIColor(r: 89, g: 193, b: 71) }

    // Lighter colors
    static var skyBlueLighter: UIColor { UIColor(r: 216, g: 241, b: 241) }
    static var babyPinkLighter: UIColor { UIColor(r: 254, g: 235, b: 238) }
    static var indigoLighter: UIColor { UIColor(r: 235, g: 218, b: 255) }
    static var jetStreamLighter: UIColor { UIColor(r: 185, g: 210, b: 204) }
    static var paleOrangeLighter: UIColor { UIColor(r: 255, g: 250, b: 244) }
    static var tealLighter: UIColor { UIColor(r: 176, g: 244, b: 235) }
    static var warmPurpleLighter: UIColor { UIColor(r: 226, g: 211, b: 236) }
    static var brickRedLighter: UIColor { UIColor(r: 256, g: 239, b: 234) }
    static var shadowColor: UIColor { UIColor(r: 150, g: 143, b: 143, alpha: 0.5) }

    // Dark theme related colors
    static var darkBarColor: UIColor { UIColor(r: 24, g: 24, b: 24) }
}
